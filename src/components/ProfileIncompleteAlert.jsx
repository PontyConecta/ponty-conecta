...
export default function ProfileIncompleteAlert({ missingFields, profileType, profile }) {
  ...
  if (hasIncomplete) {
    ...
    return (
      <div className="rounded-xl border border-primary/20 bg-primary/[0.04] p-4 lg:p-5">
        <div className="flex items-start gap-3.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Link to={createPageUrl('Profile')} className="inline-block mt-3">
              <Button size="sm" className="bg-primary hover:bg-primary/80 text-primary-foreground shadow-sm h-9 px-4 text-xs font-semibold">
                Completar Perfil
