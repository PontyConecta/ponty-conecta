...
export default function Sidebar({ profileType, currentPageName, isSubscribed, collapsed, onToggleCollapsed }) {
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <aside className={`hidden lg:flex fixed left-0 top-16 bottom-0 ${sidebarWidth} flex-col transition-all duration-200 overflow-hidden border-r`} style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-color)' }}>
        {/* Collapse toggle */}
