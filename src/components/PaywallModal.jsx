...
import { 
  Crown, Lock, CheckCircle2, Sparkles, ArrowRight, Shield, Zap
} from 'lucide-react';
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-3 mb-6">
          <p className="text-sm font-medium">Com a assinatura você tem:</p>
        ...
        <div className="p-4 rounded-xl mb-4 bg-muted">
          <div className="flex items-center justify-between">
            <div>
              <Badge className="bg-primary/10 text-primary border-0 mb-1">
                Oferta Especial
              </Badge>
