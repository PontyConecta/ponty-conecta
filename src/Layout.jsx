...
function LayoutContent({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors">
      ...
      */}
      <main className={`pt-14 lg:pt-16 pb-24 lg:pb-6 pb-mobile-safe min-h-screen transition-[margin-left] duration-200 ease-in-out ${sidebarCollapsed ? 'lg:ml-16' : 'lg:ml-64'}`}>
