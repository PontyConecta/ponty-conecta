...
export default function CreatorDashboard() {
  ...
  return (
    <div className="space-y-5 lg:space-y-6">
      ...
      {/* Wellness Event Banner — healthcare & athlete only */}
      {(creator?.creator_type === 'healthcare' || creator?.creator_type === 'athlete') && (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-foreground">
                Evento Ponty Wellness — 26 de abril
              </p>
              <p className="text-xs text-muted-foreground mt-0.5">
                Marcas de saúde e bem-estar buscando creators como você. Vagas limitadas.
              </p>
            </div>
            <Link to={createPageUrl('OpportunityFeed')}>
              <Button size="sm" variant="outline" className="shrink-0 min-h-[36px] text-xs border-primary/30 text-primary hover:bg-primary/10">
                Ver vagas
              </Button>
            </Link>
          </div>
